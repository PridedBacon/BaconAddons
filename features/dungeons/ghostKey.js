...
const protectedBlocks = new Set(["minecraft:lever", "minecraft:chest", "minecraft:trapped_chest", "minecraft:skull"]);
            ...
            if (
                ...
                (!protectedBlocks.has(playerLookingAt.type.getRegistryName()) ||
                    (playerLookingAt.type.getRegistryName() === "minecraft:skull" &&
                        !isValidSkull(playerLookingAt.pos.x, playerLookingAt.pos.y, playerLookingAt.pos.z)))
            ) {
